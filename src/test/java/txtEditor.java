...
public class txtEditor {
    ...
    public String getPost(String scenarioName,String scenarioType){
        String data="";
        String post="";
        String filePath="aegontest/src/test/resources/Documents/"+scenarioName+"/"+scenarioType+"/post.txt";
        try {
    ...
    public String getExpected(String scenarioName,String scenarioType){
        String data="";
        String post="";
        String filePath="aegontest/src/test/resources/Documents/"+scenarioName+"/"+scenarioType+"/expected.txt";
        try {
            File myObj = new File(filePath);
            Scanner myReader = new Scanner(myObj);
            while (myReader.hasNextLine()) {
